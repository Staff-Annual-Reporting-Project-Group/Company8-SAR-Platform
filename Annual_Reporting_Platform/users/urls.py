...
from .views import account_view, loginPage, logout_view, profile_view, create_report_view, delete_report, edit_report_view, registerView, user_search
...
urlpatterns = [
    ...
    path("search/", view=user_search, name="user-search"),
]